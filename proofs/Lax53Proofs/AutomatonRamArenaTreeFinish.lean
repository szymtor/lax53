...
namespace Lax53Proofs.AutomatonRamArenaTreeFinish
...
theorem finishTreeNode_spec (B : Nat) (I : WordImage)
  ...
  unfold finishTreeNode Lax53Proofs.AutomatonRamProgram.seqs
  run_vcg
  all_goals simp_all [TreeLoopState, ArenaLoaded]
  all_goals (try omega)

end Lax53Proofs.AutomatonRamArenaTreeFinish
