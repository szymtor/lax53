...
state consists only of occurrences of `Lax52.MSOSyntax.Formula`, their
intrinsic scope indices, and certified addresses in the input arena.
-/

namespace Lax53Proofs.FormulaArenaTraversalInvariant
...
open Lax53Proofs.FormulaArenaTraversalInit
...
theorem FormulaLoopState.after_step {B : Nat} {I : WordImage}
  ...
  have hrootOrderLength := Lax53Proofs.Run.arrayLength_eq hrun "FormulaOrder"
  have hfoOrderLength := Lax53Proofs.Run.arrayLength_eq hrun "FormulaFOOrder"
  have hsoOrderLength := Lax53Proofs.Run.arrayLength_eq hrun "FormulaSOOrder"
  have hrootStackLength :=
    Lax53Proofs.Run.arrayLength_eq hrun "FormulaRootStack"
  have hfoStackLength :=
    Lax53Proofs.Run.arrayLength_eq hrun "FormulaFOStack"
  have hsoStackLength :=
    Lax53Proofs.Run.arrayLength_eq hrun "FormulaSOStack"
  have hphaseStackLength :=
    Lax53Proofs.Run.arrayLength_eq hrun "FormulaPhaseStack"
...
end Lax53Proofs.FormulaArenaTraversalInvariant
