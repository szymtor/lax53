...
open Lax53Proofs.AutomatonRamArenaBounds
...
theorem exists_uniform_automatonAcceptance_expanded :
  ...
  have houtFinal : sigma'.out =
    ...
    simpa [Lax13Proofs.Imp.initEnv] using hout
  have hsingleton :
...
/--
---
conclusion: Lax53.AutomatonLinearTime.exists_uniform_automatonAcceptance
---
The fixed compiled program first reads and materializes the distinguished
structural arena and then runs the verified bottom-up evaluator. Lax58's
...
theorem exists_uniform_automatonAcceptance_proof :
  ...
  by_cases haccepts : M.2.toAutomaton M.1 |>.Accepts t <;>
    simpa [automatonAcceptancePresentation, automatonAcceptanceRaw,
      automatonInput, natOutput, Lax58.WordArena.encode,
      Lax58.StructuralPresentation.presentationOf, haccepts] using
        h M t w hpayload harena hword

/--
---
conclusion: Lax53.AutomatonLinearTime.exists_fixed_automatonAcceptance
---
...
theorem exists_fixed_automatonAcceptance_proof (M : EncodedAutomaton) :
  ...
  by_cases haccepts : M.2.toAutomaton M.1 |>.Accepts t <;>
    simpa [fixedAutomatonPresentation, automatonInput, inputMagnitudeUsing,
      natOutput, Lax58.WordArena.encode,
      Lax58.StructuralPresentation.presentationOf, haccepts] using
