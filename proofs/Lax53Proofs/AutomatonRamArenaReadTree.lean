...
namespace Lax53Proofs.AutomatonRamArenaReadTree
...
theorem initializeTreeTraversal_spec (B : Nat) (I : WordImage)
  ...
  have hrootValid := Lax53Proofs.ArenaSemantics.Represents.valid htreeRep
  have hrootLen :=
...
end Lax53Proofs.AutomatonRamArenaReadTree
