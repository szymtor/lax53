...
/-!
Array input for the Lax13 IMP+ backend.
...
This keeps Lax53's Lax13 RAM model independent of Lax62's migration to Lax67.
-/

namespace Lax53Proofs.ArrayInput
