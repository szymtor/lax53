...
namespace Lax53Proofs.MSORamCompilerSomewhere
...
open Lax53Proofs.MSORamCompilerBuild
...
theorem somewhereSymbolsBody_spec (B : Nat)
  ...
  have hchildrenLength :
      (sigma'.arrs "NewTransitionChildren").length =
        maximumRank alphabet := by
    rw [Lax53Proofs.Run.arrayLength_eq run "NewTransitionChildren"]
    exact hchildren
...
end Lax53Proofs.MSORamCompilerSomewhere
