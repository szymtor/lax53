...
namespace Lax53Proofs.IntrinsicSentenceCorrectness

open Lax52.MSOSyntax Lax53.RankedTree Lax53.TreeStructure Lax53.ValueTranslations
open Lax53Proofs.IntrinsicFormulaCompiler Lax53Proofs.IntrinsicCompilerFields
open Lax53Proofs.MarkedAlphabetEncoding Lax53Proofs.EncodedProjection
open Lax53Proofs.FiniteWordStates Lax53Proofs.FiniteAutomatonEncoding
...
theorem mapTree_id (alphabet : RankedAlphabetCode) (t : Tree alphabet.toRankedAlphabet) :
  ...
  | node a children ih =>
    ...
    exact congrArg (Lax53.RankedTree.Tree.node (A := alphabet.toRankedAlphabet) a) (funext ih)
...
end Lax53Proofs.IntrinsicSentenceCorrectness
