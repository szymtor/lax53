...
namespace Lax53Proofs.FormulaArenaTraversalRead
...
open Lax53Proofs.FormulaArenaTraversalInvariant
open Lax53Proofs.FormulaArenaTraversalLoop
...
theorem readFormula_spec (B : Nat) (I : WordImage)
  ...
  have hrootStackLength :=
    Lax53Proofs.Run.arrayLength_eq hrun1 "FormulaRootStack"
  have hfoStackLength :=
    Lax53Proofs.Run.arrayLength_eq hrun1 "FormulaFOStack"
  have hsoStackLength :=
    Lax53Proofs.Run.arrayLength_eq hrun1 "FormulaSOStack"
  have hphaseStackLength :=
    Lax53Proofs.Run.arrayLength_eq hrun1 "FormulaPhaseStack"
...
end Lax53Proofs.FormulaArenaTraversalRead
