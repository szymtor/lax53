...
namespace Lax53Proofs.AutomatonRamArenaEvaluatorCorrectness
...
theorem arenaEvaluator_spec (B : Nat) (M : EncodedAutomaton)
    ...
    Spec B (ArenaEvaluatorInitial M t)
      Lax53Proofs.AutomatonRamArenaProgram.evaluator
  ...
  simpa [Lax53Proofs.AutomatonRamArenaProgram.evaluator,
    Lax53Proofs.AutomatonRamProgram.seqs, automatonBackend,
    arenaEvaluatorImpCost] using hcombined

end Lax53Proofs.AutomatonRamArenaEvaluatorCorrectness
