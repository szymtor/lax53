...
namespace Lax53Proofs.IntrinsicModelChecking
...
open Lax53Proofs.ArenaSemantics Lax53Proofs.IntrinsicCompilerFields
open Lax53Proofs.FormulaArenaTraversalModel Lax53Proofs.PrimitiveRecursiveCode
open Lax53Proofs.IntrinsicEvaluatorPrepare Lax53Proofs.AutomatonRamBackend
...
theorem initial_initEnv (B : Nat) (alphabet : RankedAlphabetCode)
    ...
    Initial B alphabet φ t (initEnv (workspaceExt alphabet φ t)
      (Lax53.MSOLinearTime.modelCheckingInput alphabet φ t)) := by
...
end Lax53Proofs.IntrinsicModelChecking
