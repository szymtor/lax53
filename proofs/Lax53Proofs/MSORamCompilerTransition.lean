...
namespace Lax53Proofs.MSORamCompilerTransition
...
theorem appendTransitionChildBody_spec (B maximumRank : Nat)
  ...
  unfold appendTransitionChildBody Lax53Proofs.AutomatonRamProgram.seqs
  run_vcg
...
theorem beginTransitionRecord_spec (B maximumRank : Nat)
  ...
  unfold beginTransitionRecord Lax53Proofs.AutomatonRamProgram.seqs
  run_vcg
...
end Lax53Proofs.MSORamCompilerTransition
