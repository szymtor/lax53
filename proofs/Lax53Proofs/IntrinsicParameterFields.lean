...
namespace Lax53Proofs.IntrinsicParameterFields

open Lax52.MSOSyntax Lax53.ValueTranslations Lax53.TreeStructure Lax53.RankedTree
open Lax53.StructuralRepresentations Lax53.TreeModelCheckingEncoding
...
theorem sentence_fields_le (alphabet : RankedAlphabetCode)
    ...
    ∀ v ∈ fields o, v ≤ 8 + alphabet.length + maximumRank alphabet +
      3 * Lax53.MSOLinearTime.sentenceSize alphabet φ := by
  intro v hv
  have := fields_le alphabet o v hv
  have := scopes_le_size alphabet φ o ho
  unfold Lax53.MSOLinearTime.sentenceSize
  omega

end Lax53Proofs.IntrinsicParameterFields
