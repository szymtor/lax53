...
namespace Lax53Proofs.FormulaArenaTraversalBody
...
open Lax53Proofs.FormulaArenaTraversalEmit
open Lax53Proofs.FormulaArenaTraversalUnary
open Lax53Proofs.FormulaArenaTraversalOr
...
private theorem constructorTag_ne {left right : String}
  ...
  exact hnames (Lax58Proofs.StructuralCombinators.constructor_eq_iff_proof.mp hconstructors).1
...
end Lax53Proofs.FormulaArenaTraversalBody
