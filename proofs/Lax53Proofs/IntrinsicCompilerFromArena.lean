...
namespace Lax53Proofs.IntrinsicCompilerFromArena
...
open Lax53Proofs.IntrinsicCompilerFields Lax53Proofs.PrimitiveRecursiveCode
open Lax53Proofs.PrimitiveRecursiveCompile Lax53Proofs.PrimitiveRecursivePairing
open Encodable
...
theorem program_ok (c : Code) (L : Lax13Proofs.Compile.Layout) (ht : 9 ≤ L.temps)
    (hp : "P" ∈ L.arrays)
    ...
    Lax13Proofs.Compile.Com.Ok L (program c) := by
  ...
  simp [program, inputProgram, pairProgram, Lax13Proofs.Compile.Com.Ok,
    Lax13Proofs.Compile.Cond.Ok, Lax13Proofs.Compile.Expr.Ok, Lax13Proofs.Compile.condExpr,
    hα, hφ, hm, hpack, hrows, hreg]
  omega

end Lax53Proofs.IntrinsicCompilerFromArena
