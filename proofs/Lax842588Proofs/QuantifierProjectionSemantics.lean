...
namespace Lax842588Proofs.QuantifierProjectionSemantics
...
open Lax842588Proofs.MarkedTreeLifts
open Lax842588Proofs.MarkedTreeProjectionSemantics
    ...
    · letI : (treeSignature A).Structure (Node source) := markedStructure source
      ...
      have hVmap : (fun X => e '' sourceV X) = V := by
        ...
        · intro hp
          ...
          rwa [he]
      apply (Lax842588Proofs.MSOSemantics.realize_equiv e phi sourcev sourceV).mp
