...
namespace Lax842588Proofs.AutomatonRamArenaTreeStack
...
theorem pushTreeNode_spec (B : Nat) (I : WordImage)
  ...
  | node symbol children =>
      ...
      have htreeValid :=
        Lax842588Proofs.ArenaSemantics.Represents.valid htreeRep'
      have hfieldsValid :=
        Lax842588Proofs.ArenaSemantics.Represents.valid hfieldsRep
      have hsymbolValid :=
        Lax842588Proofs.ArenaSemantics.Represents.valid hsymbolRep
      have htreeLen :=
        Lax842588Proofs.ArenaSemantics.ValidAddress.lt_arenaWords_length htreeValid
      have hfieldsLen :=
        Lax842588Proofs.ArenaSemantics.ValidAddress.lt_arenaWords_length hfieldsValid
      have hsymbolLen :=
      ...
      unfold pushTreeNode Lax842588Proofs.AutomatonRamProgram.seqs
      run_vcg
      all_goals simp_all [TreePushed, ArenaLoaded, initialFrame]
      all_goals (try omega)

end Lax842588Proofs.AutomatonRamArenaTreeStack
