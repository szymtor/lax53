...
namespace Lax842588Proofs.MSORamCompilerPop
...
theorem popAutomatonDescriptor_spec (B maximumRank : Nat)
  ...
  unfold popAutomatonDescriptor Lax842588Proofs.AutomatonRamProgram.seqs
  run_vcg
...
end Lax842588Proofs.MSORamCompilerPop
