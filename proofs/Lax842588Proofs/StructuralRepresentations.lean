...
namespace Lax842588Proofs.StructuralRepresentations
...
private theorem treeStructure_injective (alphabet : RankedAlphabetCode) :
    Function.Injective (Lax842588.StructuralRepresentations.treeStructure alphabet) := by
  intro t
  induction t with
  | node symbol children ih =>
      ...
      | node otherSymbol otherChildren =>
          simp only [Lax842588.StructuralRepresentations.treeStructure,
...
/--
---
conclusion: Lax842588.StructuralRepresentations.tree_lawful
---
-/
theorem tree_lawful_proof (alphabet : RankedAlphabetCode) :
    (Lax842588.StructuralRepresentations.treePresentation alphabet).Lawful :=
  Lax560851Proofs.StructuralPresentation.presentationOf_lawful
    (treeStructure_injective alphabet)

/--
---
conclusion: Lax842588.StructuralRepresentations.sentence_lawful
---
-/
theorem sentence_lawful_proof (alphabet : RankedAlphabetCode) :
    (Lax842588.StructuralRepresentations.sentencePresentation alphabet).Lawful :=
  Lax560851Proofs.StructuralPresentation.presentationOf_lawful
    (formulaStructure_injective alphabet)

end Lax842588Proofs.StructuralRepresentations
