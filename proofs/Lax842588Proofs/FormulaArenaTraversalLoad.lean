...
namespace Lax842588Proofs.FormulaArenaTraversalLoad
...
theorem loadFormulaFrame_spec (B : Nat) (I : WordImage)
  ...
  have htagB :
    ...
    rw [htagGetD] at this
    exact this
  unfold loadFormulaFrame Lax842588Proofs.AutomatonRamProgram.seqs
  run_vcg
  all_goals simp_all [FormulaFrameLoaded, FormulaFrameReady, ArenaLoaded]
  all_goals try omega

end Lax842588Proofs.FormulaArenaTraversalLoad
