...
namespace Lax842588.MSOTreeAutomataEquivalence
...
axiom automaton_definable_by_mso {A : RankedAlphabet.{u}} {Q : Type v}
  ...
  ∃ phi : Lax146103.MSOSyntax.Sentence (treeSignature A), M.language = sentenceLanguage phi
...
axiom recognizable_iff_msoDefinable {A : RankedAlphabet.{u}}
    (L : TreeLanguage A) :
  Recognizable L ↔
    ∃ phi : Lax146103.MSOSyntax.Sentence (treeSignature A), L = sentenceLanguage phi

end Lax842588.MSOTreeAutomataEquivalence
